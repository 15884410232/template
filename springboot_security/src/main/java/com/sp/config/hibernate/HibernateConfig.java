...
//    private Environment environment;
     ...
     */
    @Bean
    public SessionFactory sessionFactory(DataSource dataSources) {
    ...
    private Properties hibernateProperties() {
        ...
        //使 Hibernate 收集统计信息以进行性能调整
        hibernateProperties.put("hibernate.generate_statistics", true);
//        //允许您自StatisticsFactory定义如何收集 Hibernate 统计信息
//        hibernateProperties.put("hibernate.stats.factory", "StatisticsFactory");
        //如果为 true，Hibernate 会在 SQL 中生成注释，以便于调试。
        hibernateProperties.put("hibernate.use_sql_comments", true);
